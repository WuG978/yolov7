...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights", type=str, default="yolov7.pt", help="initial weights path"
    )
    parser.add_argument(
        "--cfg", type=str, default="cfg/training/myyolov7.yaml", help="model.yaml path"
    )
    parser.add_argument(
        "--data", type=str, default="data/orange.yaml", help="data.yaml path"
    )
    parser.add_argument(
        "--hyp",
        type=str,
